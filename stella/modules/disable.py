...
from stella.modules.helper_funcs.handlers import CMD_STARTERS, CustomCommandHandler
...
if is_module_loaded(FILENAME):
    ...
    from stella.modules.helper_funcs.chat_status import user_admin, is_user_admin, connection_status
    from stella.modules.sql import disable_sql as sql
